...
Elementary supports collecting the following job details:
...
| Orchestrator   | Env vars                                                                                                           |
|----------------|--------------------------------------------------------------------------------------------------------------------|
| dbt cloud      | orchestrator name, job_id: `DBT_CLOUD_JOB_ID`, job_run_id: `DBT_CLOUD_RUN_ID`                                      |
| Github actions | orchestrator name, job_run_id: `GITHUB_RUN_ID`, job_url: generated from `GITHUB_SERVER_URL`, `GITHUB_REPOSITORY`, `GITHUB_RUN_ID` |
| Airflow        | orchestrator name                                                                                                  |
...
- In your Elementary schema, the fields are stored in the table `dbt_invocations`.
