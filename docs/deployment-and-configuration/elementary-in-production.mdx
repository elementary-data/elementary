...
<img src="/pics/elementary-managed-beta.png" href="mailto:team@elementary-data.com?subject=Tell me about Elementary Managed!&body=I'm interested in learning more about the Elementary Managed private beta. Please send me further details."/>
...
2. Airflow
3. Prefect
4. Meltano - Checkout the [custom Elementary integration](https://hub.meltano.com/utilities/elementary) developed by [Stéphane Burwash](https://github.com/SBurwash) - [Potloc](https://www.potloc.com/). 
5. Using cron
