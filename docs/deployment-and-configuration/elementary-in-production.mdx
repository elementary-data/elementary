...
<a href="mailto:cloud@elementary-data.com?subject=Tell me about Elementary Managed!&body=I'm interested in learning more about the Elementary Managed private beta. Please send me further details.">
...
2. **Generate a report** - Use the `edr report` or `edr send-report` that has built in support for sending the report to Slack / GCS / S3.
...
1. <a href="mailto:team@elementary-data.com?subject=Tell me about Elementary Managed!&body=I'm interested in learning more about the Elementary Managed private beta. Please send me further details.">
     Elementary Managed
   </a>
