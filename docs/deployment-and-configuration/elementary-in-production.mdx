...
2. GitHub Actions - Checkout the [Elementary GitHub Action workflow](https://github.com/elementary-data/run-elementary-action) we created.
3. Airflow
4. Prefect
5. Meltano - Checkout the [custom Elementary integration](https://hub.meltano.com/utilities/elementary) developed by [Stéphane Burwash](https://github.com/SBurwash) - [Potloc](https://www.potloc.com/). 
6. Using cron
