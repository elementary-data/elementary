...
By deploying the CLI, you can send Slack alerts and self-host the Elementary report, a comprehensive view of your dbt runs and all dbt test results, helping you track data lineage, test coverage, and overall pipeline health. Quickly identify issues, monitor trends, and assess data reliability across your workflows.
