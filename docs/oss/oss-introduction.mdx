...
---
**Elementary OSS is a CLI tool that works alongside the [Elementary dbt package](/guides/modules-overview/dbt-package).** With the dbt package, you gain powerful anomaly detection tests and metadata tables to monitor data quality trends over time.
...
For a scalable and collaborative data quality platform, **look into the [Elementary Cloud Platform](/cloud/introduction)** - A fully managed, enterprise-ready solution with ML-powered anomaly detection, flexible data discovery, integrated incident management, and collaboration tools—all with minimal setup and infrastructure maintenance. See here a [detailed features comparison](/overview/cloud-vs-oss).
