...
<Note>
  Elementary OSS covers a single dbt project. The CLI reads the schema created by the Elementary dbt package, so it runs as part of that project. To cover more than one project, or to connect a data warehouse without dbt, use the [Elementary Cloud Platform](/cloud/introduction).
</Note>
...
For a scalable and collaborative data quality platform, **look into the [Elementary Cloud Platform](/cloud/introduction)** - A fully managed, enterprise-ready solution with ML-powered anomaly detection, flexible data discovery, integrated incident management, and collaboration tools—all with minimal setup and infrastructure maintenance. See here a [detailed features comparison](/cloud/cloud-vs-oss).

### What can you do with Elementary OSS?

<Card title="Utilize the Elementary dbt package for Elementary tests and tables" icon="gear" iconType="solid" href="/data-tests/introduction" />
