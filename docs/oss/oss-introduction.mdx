...
<Card title="Utilize the Elementary dbt package for Elementary tests and tables" icon="gear" iconType="solid" href="/oss/deployment-and-configuration/elementary-in-production" />
