...
<Note>
  Elementary OSS is built for dbt users. The CLI reads the schema created by the Elementary dbt package, so it runs as part of a dbt project. If you don't use dbt, the [Elementary Cloud Platform](/cloud/introduction) connects to your data warehouse directly.
</Note>
