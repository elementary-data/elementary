...
After you [install the dbt package](../getting-started/quickstart-data-monitoring#install-the-dbt-package) and related configuration, you can add Elementary data tests.
...
1. [Test arguments](/test-configuration#test-arguments) - Test specific arguments.
2. [Table configuration]() - Configure the timestamp column and details of a monitored table.
3. [Global vars](/test-configuration#data-monitoring-global-vars) - Optional configuration parameters of the operation.
