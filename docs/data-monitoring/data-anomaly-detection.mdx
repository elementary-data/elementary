...
Elementary data monitoring includes a [dbt package](../learn/dbt-package) and CLI.
...
[Elementary dbt package](../getting-started/quickstart-data-monitoring#install-the-dbt-package)
...
2. [Configure data monitors as tests](./test-configuration), just like you configure your native dbt tests.
...
This is the default Elementary uses as well, and it can be changed using the var `anomaly_score_threshold` in the [global configuration](./test-configuration).
...
<img src="../img/z-score.png" alt="Z Score" />
