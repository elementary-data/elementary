...
<CardGroup cols={2}>
  <Card title="Cloud Tests" href="/cloud/features/data-tests/cloud-tests-overview">
    ML-powered Cloud tests for freshness and volume run automatically. Data contract and dbt tests provide validation coverage.
  </Card>
  <Card title="Data Tests" href="/cloud/features/data-tests/cloud-tests-overview">
  ...
  <Card title="Code & UI Configuration" href="/cloud/features/data-tests/cloud-tests-overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Snowflake Semantic Views" href="/cloud/features/data-lineage/semantic-layer">
    Discover, catalog, and trace lineage through Snowflake Semantic Views — metrics, dimensions, and facts connected to your physical tables.
  </Card>
  ...
  <Card title="Incident Management" href="/cloud/features/alerts-and-incidents/incidents">
