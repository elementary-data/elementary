...
<CardGroup cols={2}>
  <Card title="Cloud Tests" href="/cloud/features/data-tests/cloud-tests-overview">
    Run freshness, volume, data contract, and custom SQL tests outside your dbt pipeline.
  </Card>
  <Card title="Elementary Runtime (Private Beta)" href="/cloud/features/elementary-runtime">
    Run supported data-quality queries inside your environment while Elementary Cloud manages the workflow.
  </Card>
