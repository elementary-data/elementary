...
<TipInfo>This means Elementary will use `your_schema_elementary` as its schema.</TipInfo>
...
Once the elementary dbt package has been installed and configured, your test results, your dbt run results and [dbt artifacts](/dbt-artifacts) will be loaded to elementary models.
...
1. [​Add anomaly detection as dbt tests](/tests)📈
2. [​Install the Elementary CLI](/generate-reports#install-the-elementary-cli) to:

   - [​Visualize all dbt test results and runs in a report](/generate-reports)✨

   - [Send informative Slack alerts](/slack-alerts)📣
