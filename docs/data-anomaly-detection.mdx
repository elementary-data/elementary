...
Elementary data monitoring includes a [dbt package](/dbt-package) and CLI. 
...
[Elementary dbt package](/quickstart-data-monitoring#install-the-dbt-package)
...
This is the default Elementary uses as well, and it can be changed using the var `anomaly_score_threshold` in the [global configuration]().
