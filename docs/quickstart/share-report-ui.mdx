...
You can control the name of the report by providing `--slack-file-name <REPORT_NAME>` to the `edr monitor send-report` command.
...
You can control the name of the report by providing `--bucket-file-path <REPORT_NAME>` to the `edr monitor send-report` command.
The report will be uploaded to your bucket under the provided path:
