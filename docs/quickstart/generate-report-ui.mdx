...
## Send Report to External Platform

You can distribute the report by sending it to external platforms such as Slack, S3, or GCS.

Refer to [this guide](./send-report-ui) for more information.
