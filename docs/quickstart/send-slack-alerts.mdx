...
- Notification settings:
  ...
  - Choose which fields to display in your alert
...
## Customize alerts: Add metadata to enrich alerts (owners, subscribers, tags, etc.)
...
Also, you can use these custom Elementary fields:
...
## Notification settings: determine how you want to get your alerts

Elementary also allows you to configure how you want to get your alerts so you can make sure the right information, reach the right people, at the right frequency. All of this should be done in order to make the alerts valuable and avoid fatigue. 
...
Elementary also supports grouping alerts by table. In this case, you will get a single Slach notification that will contain all the test warning/errors/failures that relates to a model, as well as that model's errors. The created message will do a union of the relevant owners, tags and subscribers.
