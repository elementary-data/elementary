...
Elementary offers automated [Column-Level Lineage](/features/data-lineage/column-level-lineage) functionality, enriched with the latest test and monitors results.
It is built with usability and performance in mind. 
The column-level lineage is built from the metadata of your data warehouse, and integrations with [BI tools](features/data-lineage/exposures-lineage#automated-lineage-to-the-bi) such as Looker and Tableau.
