...
Monitors are automatically created on all of your sources, and additional ones can be [added, edited and removed manually](/features/anomaly-detection/monitors-configuration). Their results are displayed in the application in the same way as package tests.
