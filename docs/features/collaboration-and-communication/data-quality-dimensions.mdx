...
The data quality scores are presented in a [data health dashboard](/features/collaboration-and-communication/data-health#data-health-dashboard), data catalog integrations, and more. 
