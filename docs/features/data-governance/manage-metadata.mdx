...
From a single interface, you can view and filter assets, edit metadata fields individually or in bulk, and even use AI to generate high-quality descriptions—saving time and enhancing data discoverability. All changes are version-controlled via pull requests to keep your dbt project in sync.

To get the most out of this feature, check out our [Data Governance Best Practices](https://docs.elementary-data.com/best-practices/governance-for-observability) guide.
