...
Note that although in dbt the 'location' parameter is optional, in Elementary lineage it is mandatory. Here are details
about [BigQuery locations](https://cloud.google.com/bigquery/docs/locations).
