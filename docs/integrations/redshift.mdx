...
<GenerateElementaryCLIProfile profileDocsLink="https://docs.getdbt.com/reference/warehouse-profiles/redshift-profile#authentication-methods" />
...
dbt's documentation of [Redshift profile](https://docs.getdbt.com/reference/warehouse-profiles/redshift-profile) for
further details.
