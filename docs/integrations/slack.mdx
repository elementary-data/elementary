...
Elementary Slack integration includes sending [Slack alerts](/quickstart/send-slack-alerts) on failures in dbt tests and models, and the option to distribute the [data observability report](/quickstart/generate-report-ui) as a message attachment.
