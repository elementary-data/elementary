...
When selecting a dbt model/source in the navigation bar, a lineage icon will appear next to the selected dbt model/source: <img src="../pics/lineage-icon.png" alt="Lineage icon" />.
