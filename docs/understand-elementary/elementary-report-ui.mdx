...
In order to visualize the data from the [dbt-package](../project-overview/contributions#guide-on-contributing-to-the-dbt-package) tables, use the [CLI](./cli-install) you can generate the Elementary UI.
...
<img src="https://res.cloudinary.com/mintlify/image/upload/v1659304885/elementary/Test-Runs-video-demo_ubxssd.gif" alt="Test runs demo" />
...
Refer to [this guide](../quickstart/send-slack-alerts) for detailed instructions.
