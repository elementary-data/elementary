...
In order to send Slack alerts after you deploy the [dbt-package](../project-overview/contributions#guide-on-contributing-to-the-dbt-package) and configure tests, use the [CLI](./cli-install) and the [Slack](../integrations/slack) integration.
