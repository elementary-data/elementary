...
sidebarTitle: "0.6.7"
description: "Python v0.6.7, dbt package v0.6.11"
---
...
### Github links:
- [v0.6.7 Python](https://github.com/elementary-data/elementary/releases/tag/v0.6.7)
- [v0.6.11 dbt package](https://github.com/elementary-data/dbt-data-reliability/releases/tag/0.6.11)