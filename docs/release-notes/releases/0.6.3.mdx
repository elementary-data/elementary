...
- **Slack alerts V2** 2️⃣
  - **Elementary now supports customizing alerts, so you could notify data producers and consumers** 🧑‍🔧
    - Instead of sending detailed technical alerts, you can select fields. Learn more here [how to configure it](/quickstart/send-slack-alerts#customize-alerts-owners-test-descriptions-tags-subscribers-and-layout).
...
- **New data tests** 🩺
  - [Advanced schema tests](/guides/add-schema-tests), **useful for source monitoring and enforcing data contracts:** ✅
  ...
  - New and [improved table anomalies tests](/guides/add-elementary-tests), including `where_expression`: 📉
...
- **Monitor job results** ⚛️
  ...
  - [The new columns can be viewed here](https://github.com/elementary-data/dbt-data-reliability/blob/4695474ba10740a95822954Jumpei Chikamoric44adbc52f4f2af95/models/run_results.yml#L81).
