...
- **We added many cool new features to our anomaly detection tests!**
  ...
  - `fail_on_zero` - You can now configure your volume anomaly tests to fail if there are exactly 0 new records, in addition to the anomaly detection algorithm. Read more [here](https://docs.elementary-data.com/guides/anomaly-detection-configuration/fail_on_zero)
  - `detection_delay` - If your data loads with an expected delay, you can now [delay the detection period](https://docs.elementary-data.com/guides/anomaly-detection-configuration/detection-delay). This will prevent false alerts on freshness and volume. Thanks [Francois Forster](https://github.com/francoisforster) for raising the issue and making this amazing contribution!
  - `ignore_small_changes` - If your data set is very static, and even a small change can cause a false anomaly detection, you can now use percentiles to ignore small changes. Read more about this [here](https://docs.elementary-data.com/guides/anomaly-detection-configuration/ignore_small_changes)
