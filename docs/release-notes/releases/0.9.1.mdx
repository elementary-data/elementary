...
- **New Seasonality Options: hour_of_day and hour_of_week** 🌞🌙
  ...
  - Check out the [docs](https://docs.elementary-data.com/guides/anomaly-detection-configuration/seasonality)
...
- **Alert Suppression in CLI** 🚦
  ...
  - Check out the [docs](https://docs.elementary-data.com/quickstart/send-slack-alerts)
