...
sidebarTitle: "0.6.5"
description: "Python v0.6.5, dbt package v0.6.10"
---
...
- **Alerts suppression** 💤
  ...
  - [Docs here](/quickstart/send-slack-alerts#customize-alerts-owners-test-descriptions-tags-subscribers-layout-and-suppression)
...
- **Alerts filtering using selectors** 🔘
  ...
  - [Docs here](/quickstart/send-slack-alerts#execute-the-cli)
...
### Github links:
- [v0.6.5 Python](https://github.com/elementary-data/elementary/releases/tag/v0.6.5)
- [v0.6.10 dbt package](https://github.com/elementary-data/dbt-data-reliability/releases/tag/0.6.10)