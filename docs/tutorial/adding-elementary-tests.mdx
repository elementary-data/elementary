...
To read more about Elementary's suite of tests click [here](/guides/add-elementary-tests). <br/>
...
```
<Info>
Notice that we already defined the **timestamp_column** at the model level, so we don't have to define it in the test. [This page](/guides/elementary-tests-configuration) has in-depth details on test priorities.
</Info>
</Accordion>
<br/>
