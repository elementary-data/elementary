...
Data monitoring includes a [dbt package](/data-tests/dbt/dbt-package) and the edr CLI for generating the report.
...
Data anomalies tests are included in the [dbt package](/data-tests/dbt/dbt-package).
...
The dbt artifacts uploader is included in the [dbt package](/data-tests/dbt/dbt-package).
