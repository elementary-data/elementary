...
<CardGroup cols={1}>
  <Card
    ...
    iconType="solid"
    href="/cloud/features/data-tests"
  >
  ...
  <Card
    ...
    icon="table-tree"
    iconType="regular"
    href="/data-tests/dbt/dbt-artifacts"
  >
  ...
  <Card
    ...
    iconType="regular"
    href="/cloud/features/elementary-alerts"
  >
  ...
  <Card
    ...
    icon="arrow-progress"
    iconType="solid"
    href="/cloud/features/data-lineage/lineage"
  >
  ...
  <Card
    ...
    href="/cloud/features/anomaly-detection/automated-monitors"
  ...
  <Card
    ...
    href="/cloud/features/config-as-code"
    icon="code"
    iconType="solid"
  >
    Manage Elementary configuration as code in your dbt project, or from the UI.
  </Card>
  <Card
    title="Data Catalog"
    icon="folder-tree"
    iconType="solid"
    href="/cloud/features/collaboration-and-communication/catalog"
  >
...
<Card title="Automated Volume & Freshness Monitors">
  ...
  By querying only metadata (e.g. information schema, query history), the monitors don't add compute costs.
</Card>
