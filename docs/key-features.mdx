...
<CardGroup cols={1}>
  ...
  <Card title="Slack alerts" icon="slack" iconType="regular" href="/features/elementary-alerts">
  ...
  <Card
    title="End-to-end data lineage" icon="arrow-progress" iconType="solid" href="/features/lineage">
    Inspect dependencies including Column Level Lineage and integration with BI tools.
  </Card>
  <Card
    title="Automated monitors" href="/features/automated-monitors"
    icon="wand-magic-sparkles" iconType="solid">
    Out of the box freshness, volume and schema monitoring.
  </Card>
  <Card
    title="Configuration as code" href="/features/config-as-code"
    icon="code" iconType="solid">
    All the Elementary configuration is managed in your dbt code.
  </Card>
  <Card
    title="Data Catalog"
    icon="folder-tree" iconType="solid"
