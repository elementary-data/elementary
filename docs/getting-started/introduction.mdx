...
Elementary dbt tests are [data monitors](../data-monitoring/data-anomaly-detection#tests-and-monitors-types) that collect metrics and metadata over time.
On each execution, the tests analyze the new data, compare it to historical metrics, and [alert](../integrations/slack) on [anomalies](../data-monitoring/data-anomaly-detection#anomaly-detection) and outliers.
