...
We recommend using pip, for other installation options refer to the [download and install guide](../learn/cli-install#install-and-configure).
...
For further information and other authentication options, refer to the [connection profile guide](../learn/cli-install#cli-configuration).
