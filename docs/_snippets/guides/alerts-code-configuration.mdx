...
<Warning>
  Vars will be deprecated soon! For OSS users, we recommend filtering the alerts using [CLI
  selectors](/oss/guides/alerts-configuration#alerts-cli-flags) instead.
</Warning>
