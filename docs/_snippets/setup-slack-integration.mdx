...
<a
  href="https://res.cloudinary.com/mintlify/image/upload/v1659304888/elementary/elementary_logo_512x512_iu1u4k.png"
  download
>
  <img
...
<img
  src="https://github.com/elementary-data/elementary/blob/prod/docs/pics/slack-app-permissions.png?raw=true"
  alt="Slack scopes"
/>
...
slack:
  ...
  group_alerts_by: <"by_table"> or <"by_alert">
