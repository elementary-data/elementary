...
This includes investigating the root cause ane impact of issues, communicating issues to the relevant people, assigning owners to fix issues, keeping track of open incidents and more.
