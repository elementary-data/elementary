...
This includes investigating issues root cause and impact, communicating issues to the relevant people, assigning owners to fix issues, keeping track of open incidents and more.
