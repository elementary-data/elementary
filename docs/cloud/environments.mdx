...
- **Asset groups** — databases and schemas you select directly in the warehouse. Use these for tables and views built by ETL tools, orchestrators, or SQL scripts.
