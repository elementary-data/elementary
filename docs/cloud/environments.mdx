...
<Frame caption="Separate environments listed in Account settings">
  <div className="dark:bg-white rounded-md p-4">
    <img
      ...
      alt="Separate environments listed in Account settings"
    />
  </div>
</Frame>
...
5. Choose the asset source type:
   - **dbt project** — uses dbt models, tests and run results. Requires the [Elementary dbt package](/data-tests/dbt/quickstart-package).
...
<Frame caption="Adding a warehouse schemas asset source in Environment content">
  <img
    src="/pics/environment-content-asset-sources.png"
    alt="Adding a warehouse schemas asset source in Environment content"
  />
</Frame>
