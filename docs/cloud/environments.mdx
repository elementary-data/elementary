...
- **A selection of warehouse databases and schemas** — picked directly in the warehouse. Use this for tables and views built by ETL tools, orchestrators, or SQL scripts.
