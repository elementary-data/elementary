...
An environment can hold several of either kind, and can mix them. An environment built entirely from warehouse asset sources works on its own, monitored from warehouse metadata — dbt is optional.
