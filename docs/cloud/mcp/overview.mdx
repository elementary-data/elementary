...
<Columns cols={2}>
  <Card title="MCP Setup Guide" icon="panel-left-close">
  </Card>
  <Card title="Available MCP Tools" icon="panel-right-close">
  </Card>
</Columns>
...
- **Full asset details - M**etadata, column definitions, and test coverage
