...
In order to have that table name appear in the UI in the test results, test execution and more screens, you may set it up by adding the following to the config block of your singular test file:
```
{{ config(
