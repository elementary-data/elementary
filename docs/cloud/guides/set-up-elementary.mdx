...
sidebarTitle: "Set up Elementary"
---

<Info>
Here's a link to a checkbox version of this guide that you can download and use to track your progress: [Download as markdown](/cloud/guides/set-up-elementary.md).
</Info>
