---
title: "Configuring Elementary for Development and Production"
...
For more information about disabling hooks, see the [FAQ section on disabling hooks](/oss/general/faq#can-i-disable-the-on-run-end-hooks-or-results-uploading).
