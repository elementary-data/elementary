...
Create a service acount with the following roles ([docs](https://cloud.google.com/bigquery/docs/control-access-to-resources-iam))
 * Role `roles/bigquery.dataViewer` on your elementary dataset (usually `<dbt_dataset>_elementary`).
 * Role `roles/bigquery.metadataViewer` on your dbt dataset and all of the dbt source datasets.
