...
The different information types are detailed in the table bellow.
...
This is an opt-out feature that shows a sample of a few raw failed rows for failed tests, to help them triage and understand the problem.
To avoid this sampling, set the var `test_sample_rows_count: 0` in your `dbt_project.yml` (default is 5 sample rows).

| Information type   | Examples                                                                                                                                                                          | Usage                                                                                                                                                                               |
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
