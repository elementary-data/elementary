...
A fully managed platform for data observability, quality, and governance, with no infrastructure to maintain. It connects directly to your data warehouse and covers your whole stack end to end - from ingestion through the warehouse and dbt to BI and AI consumption - across multiple projects, with column-level lineage, ML-powered detection, governance, and enterprise security built in.
...
<AccordionGroup>
  ...
  <Accordion title="Can I move from Elementary OSS to Elementary Cloud?">
    Yes. If you use dbt, Cloud uses the same Elementary dbt package, so moving from OSS to Cloud means connecting your existing dbt project rather than starting over. You can also connect your data warehouse directly. See the [dbt package quickstart](/cloud/onboarding/quickstart-dbt-package).
  </Accordion>
