...
| **Performance & cost** | <ul><li>Model and test performance</li></ul>            | <ul><li>[Model and test performance](/cloud/features/performance-monitoring/performance-monitoring)</li><li>[Pipeline task performance monitor](/cloud/features/anomaly-detection/cloud-pipeline-task-performance)</li><li>Continuous cost and performance monitoring</li></ul> |
