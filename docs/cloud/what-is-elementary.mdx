...
**Elementary is the platform for teams who make data quality a priority.**
...
- **Enablement:** With a built-in [**data catalog**](/cloud/features/collaboration-and-communication/catalog), Elementary makes it easy for analysts, product managers, and other consumers to search for data, see validation status, and understand asset health.

Elementary is available as both an open-source dbt package and CLI tool, or as a fully managed Cloud Platform with advanced data observability tools. Each version supports different needs, read on to learn more about what they offer.
