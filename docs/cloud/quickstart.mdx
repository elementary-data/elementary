...
Setup starts with your data warehouse. You create an [environment](/cloud/environments), connect it to the warehouse, and choose which assets it monitors. dbt is optional — if you use it, connect your dbt project as one of the environment's asset sources to bring in your models, tests, and run results.

There are two ways to get started:

- **Set it up yourself** — perfect for smaller teams or hands-on users.
