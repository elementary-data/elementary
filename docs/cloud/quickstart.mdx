...
You’re moments away from full source-to-BI observability—so you can detect issues before they spread, guarantee trusted inputs for dashboards, models, and AI workflows, enforce governance policies, make data easy to find, and let AI agents automate coverage, triage, optimization and governance.
...
<Callout icon="dbt" color="#FFC107" iconType="regular">To use Elementary, you must be a dbt user. We will soon release a Python SDK for any Python pipeline and test.</Callout>
