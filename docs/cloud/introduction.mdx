...
<CardGroup cols={3}>
  <Card title="Cloud Platform Features" icon="diagram-project" href="https://docs.elementary-data.com/cloud/features" >
  </Card>
 <Card title="Integrations" icon="puzzle-piece" href="https://docs.elementary-data.com/features/integrations" >
  </Card>
  <Card title="Architecture and Security" icon="user-lock" href="https://docs.elementary-data.com/cloud/general/security-and-privacy" >
  </Card>
</CardGroup>=
