...
<Warning>
Important: The user connecting PagerDuty must have at least a "User" role (not "Limited User") in PagerDuty, as this role is required to:
- Create incidents in PagerDuty services
- Add Events API v2 integrations to services
- Complete the OAuth authentication process when prompted
- Verify the connection by using the test connection feature
</Warning>
