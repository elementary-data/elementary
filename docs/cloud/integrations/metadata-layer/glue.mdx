...
The AWS Glue integration in Elementary will allow you to automatically monitor our Iceberg tables in Glue, by continouously syncing metadata about Iceberg snapshots.
