---
title: "Tableau"
description: "Tableau is a powerful data visualization software that allows users to create interactive and insightful charts, graphs, and dashboards from various data sources"
---
...
- **Site URL:** Copy and paste the URL you see when you visit the homepage of your Tableau instance. e.g. `https://prod-useast-a.online.tableau.com/#/site/dev/projects`
- **Site Name**: The site name according to the provided Site URL. e.g. `https://prod-useast-a.online.tableau.com/`
