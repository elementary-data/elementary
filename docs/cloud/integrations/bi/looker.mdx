---
title: "Looker"
description: "Looker is Google's business intelligence and data analytics platform that allows users to explore, visualize, and analyze data from various sources in real-time."
---
...
- [Github](/cloud/integrations/code-repo/connect-code-repo/github)
- [Gitlab](/cloud/integrations/code-repo/connect-code-repo/gitlab)