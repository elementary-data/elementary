...
This feature makes it easier to manage alert delivery and ensure alerts are routed as expected—especially across different teams, environments, or test types.