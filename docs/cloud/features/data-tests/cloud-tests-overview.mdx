...
description: "Tests that run in Elementary Cloud, outside your dbt pipeline - freshness, volume, data contracts, and custom SQL, configured in the UI with no dbt project required."
...
They run on every asset in the [environment](/cloud/environments), whether it came from a dbt project or from warehouse schemas selected directly in the warehouse.
