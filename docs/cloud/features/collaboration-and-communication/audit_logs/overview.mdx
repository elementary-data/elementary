...
In addition to exporting logs as CSV files, you can stream logs in real-time to external log management services for centralized monitoring and analysis.
