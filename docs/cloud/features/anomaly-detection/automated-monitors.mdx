...
import AutomatedMonitorsIntro from '/_snippets/cloud/features/anomaly-detection/automated-monitors-intro.mdx';
import AutomatedMonitorsCards from '/_snippets/cloud/features/anomaly-detection/automated-monitors-cards.mdx';
...
Monitors are automatically created on all of your sources, and additional ones can be [added, edited and removed manually](/cloud/features/anomaly-detection/monitors-configuration). Their results are displayed in the application in the same way as package tests.
