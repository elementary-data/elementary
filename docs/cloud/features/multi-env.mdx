...
Multi-environment support is currently available through the Elementary team.
If you want to enable it or learn more about recommended setups, reach out to the team.

A self-serve configuration flow will be available soon.
