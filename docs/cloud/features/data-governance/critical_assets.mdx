...
<Note>Critical assets work best when ownership and tagging are already in place. See [Governance best practices](/cloud/best-practices/governance-for-observability) for how to set that foundation.</Note>
