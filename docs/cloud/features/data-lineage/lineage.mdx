...
- **Ingestion sources** — tables from your data warehouse, including those loaded by tools like Fivetran, and [assets synced directly from warehouse schemas](/cloud/environments)
