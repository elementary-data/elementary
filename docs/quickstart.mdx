...
Once the elementary dbt package has been installed and configured, your test results, run results and [dbt artifacts](./guides/dbt-artifacts.mdx) will be loaded to elementary schema tables.
...
2. [​Add data anomaly detection dbt tests](./quickstart/add-elementary-tests) 📈
