...
Once the elementary dbt package has been installed and configured, your test results, run results and [dbt artifacts](./dbt/dbt-artifacts.mdx) will be loaded to elementary schema tables.
