...
<pre>
 <code>
  ...
  Anomaly detection tests with timestamp_column:
   ...
   -- <a href="/data-tests/anomaly-detection-configuration/exclude_detection_period_from_training"><font color="#CD7D55">exclude_detection_period_from_training: [true | false]</font></a>
  ...
  dimension_anomalies test:
   -- <a href="/data-tests/anomaly-detection-configuration/exclude-final-results"><font color="#CD7D55">exclude_final_results: [SQL where expression on fields value / average]</font></a>
