...
<Card horizontal="true" title="Generate your anomaly test with Elementary AI" icon="wand-magic-sparkles" href="https://elementary-community.slack.com/archives/C08HW57FGN9"/>
