  ...
  tests:
    &nbsp;&nbsp;-- elementary.volume_anomalies:
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/data-tests/anomaly-detection-configuration/detection-delay"><font color="#CD7D55">count: int</font></a>
          <a href="/data-tests/anomaly-detection-configuration/anomaly_exclude_metrics"><font color="#CD7D55">anomaly_exclude_metrics: [where expression filtering metric_date / metric_time_bucket / metric_value]</font></a>
 </code>
</pre>
