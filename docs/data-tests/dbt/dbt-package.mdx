...
Quickstart the Elementary dbt package in minutes [here](/data-tests/dbt/quickstart-package.mdx). The repository and source code of the  can be [found here](https://github.com/elementary-data/dbt-data-reliability).
