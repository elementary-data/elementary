...
Quickstart the Elementary dbt package in minutes [here](elementary/docs/data-tests/dbt/quickstart-package.mdx), the repository and source code of the  can be [found here](https://github.com/elementary-data/dbt-data-reliability).
