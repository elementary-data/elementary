...
This is done to detect [significant changes and deviations](/guides/data-anomaly-detection), that are probably data reliability issues.
...
When a test fail, it means that an anomaly was detected on this metric and dataset. To learn more, refer to [anomaly detection method](/guides/data-anomaly-detection).
...
Read about it in [data anomaly detection method](/guides/data-anomaly-detection).
