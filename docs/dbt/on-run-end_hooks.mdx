...
As a data observability solution, the completeness and freshness of the results Elementary collects is critical. 
...
We stringly recommend not to disable the hooks for environments you want to minitor using Elementary. 
