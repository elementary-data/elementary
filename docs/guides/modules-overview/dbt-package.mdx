...
The impact of the package on `dbt run` is minimal, and most of the processing happens as part of the data monitors as
dbt tests, that are executed on `dbt test`.
...
The code of the Elementary dbt package can be found
here: [https://github.com/elementary-data/dbt-data-reliability](https://github.com/elementary-data/dbt-data-reliability)
...
the [Elementary report](/understand-elementary/elementary-report-ui).
