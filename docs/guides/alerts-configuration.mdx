...
<pre>
  <code>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="/guides/alerts-configuration#alert_fields">
      <font color="#CD7D55">
...
<Warning>Vars will be deprecated soon! We recommend filtering the alerts using [CLI selectors](/guides/alerts-configuration#alerts-cli-flags) instead</Warning>
