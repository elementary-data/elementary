...
Snowflake note: Snowflake has "synonym" data types, like `VARCHAR` and `TEXT`. These will be considered as equals by the tests. Types are converted internally to deal with this.
