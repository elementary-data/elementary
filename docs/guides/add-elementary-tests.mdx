...
_Note_: The `generate_json_schema_test` macro relies on a 3rd-party python library called `genson`. If you are using
...
_Note_: This test relies on our [Python tests capability](/guides/python-tests), and is currently only supported for
