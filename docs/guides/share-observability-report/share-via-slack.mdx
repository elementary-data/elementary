...
By default, sharing the Slack message will include a [report summary](/guides/share-observability-report/send-report-summary).

#### CLI `send-report` command

After you [set up a Slack app and token](/integrations/slack#slack-integration-setup), run the command:
