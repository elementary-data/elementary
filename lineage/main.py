...
@click.option(
    '--table', '-t',
    type=str,
    help="Filter on a table to see upstream and downstream dependencies of this table (see direction param).",
)
@click.option('--direction',
              ...
              help="Sets direction of dependencies when filtering on a specific table (default is both, "
                   "meaning showing all the dependencies of this table).",
              default='both',
              cls=RequiredIf,
              required_if='table')
@click.option('--depth',
              ...
              help="Sets how many levels of dependencies to show when filtering on a specific table "
                   "(default is None, meaning showing all levels of dependencies).",
              default=None,
              cls=RequiredIf,
              required_if='table')
def main(start_date: datetime, end_date: datetime, profiles_dir: str, profile_name: str, open_browser: bool,
         export_query_history: bool, full_table_names: bool, ignore_schema: bool, table: str,
