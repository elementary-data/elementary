...
@pytest.mark.parametrize("json_table_column, full_table_names, expected_parsed_result", [
    ...
    (create_bigquery_table_colum('db2', 'sc1', 't1'), True, None),
    (create_bigquery_table_colum('db1', 'sc1', 't1'), False, 't1'),
    (create_bigquery_table_colum('db2', 'sc1', 't1'), False, None),
    (create_bigquery_table_colum('db1', 'sc2', 't1'), True, None),
...
def test_bigquery_query_parse():
    ...
    reference = BigQueryQuery(raw_query_text, query_context, 'db1', 'sc1')
