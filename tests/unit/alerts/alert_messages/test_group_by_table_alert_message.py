...
from elementary.monitor.alerts.alert_messages.test_alert_message import (
    get_group_by_table_alert_message_body,
)
...
def test_get_group_by_table_alert_message_body(
    ...
    message_body = get_group_by_table_alert_message_body(alerts_group)
    adaptive_card_filename = f"adaptive_card_group_by_table_model-errors-{has_model_errors}_test-failures-{has_test_failures}_test-warnings-{has_test_warnings}_test-errors-{has_test_errors}_link-{has_link}.json"
