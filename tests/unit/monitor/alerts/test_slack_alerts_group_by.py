...
from elementary.monitor.alerts.group_of_alerts import GroupOfAlertsBySingleAlert, GroupOfAlerts, GroupOfAlertsByAll, \
    GroupOfAlertsByTable, TagsComponent, OwnersComponent, SubsComponent, ErrorComponent, WarningComponent, \
    FailureComponent
...
class MockAlert:
    ...
    model_meta: Optional[str]  # this string should be a json of a dict that has or has not the key "channel"
...
def mock_data_monitoring_alerts(mock_config):
    return MockDataMonitoringAlerts(config=mock_config,
                                    execution_properties=dict())
...
AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING = MockAlert(status="warn",
...
AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING = MockAlert(status="fail",
                                                    slack_group_alerts_by=None,
                                                    model_unique_id=MODEL_1,
...
AL_FAIL_MODEL2_NO_CHANNEL_NO_GROUPING = MockAlert(status="fail",
                                                  slack_group_alerts_by=None,
                                                  ...
                                                  subscribers=[],
                                                  tags=TAGS_3)
AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_ALERT = MockAlert(status="fail",
                                                             ...
                                                             subscribers=[],
                                                             tags=TAGS_1)
AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE = MockAlert(status="fail",
                                                             ...
                                                             subscribers=[],
                                                             tags=TAGS_1)
AL_ERROR_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE = MockAlert(status="error",
                                                              slack_group_alerts_by="by_table",
                                                              model_unique_id=MODEL_2,
                                                              slack_channel=None,
                                                              detected_at=DETECTED_AT,
                                                              ...
                                                              subscribers=[],
                                                              tags=TAGS_1)
AL_ERROR_MODEL3_NO_CHANNEL_WITH_GROUPING_BY_ALERT = MockAlert(status="error",
                                                              slack_group_alerts_by="by_alert",
...
def check_eq_group_alerts(grp1: GroupOfAlerts, grp2: GroupOfAlerts):
    ...
    ret &= (grp1._components_to_attn_required == grp2._components_to_attn_required)  # same owners, tags, subscribers
...
@Parametrization.case(
    ...
    expected_execution_properties={"had_group_by_alert": False,
...
@Parametrization.case(
    ...
    expected_alert_groups=[GroupOfAlertsBySingleAlert(alerts=[AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING],
                                                      default_channel_destination=DEFAULT_CHANNEL)],
    expected_execution_properties={"had_group_by_alert": True,
                                   "had_group_by_table": False,
                                   "had_group_by_all": False}
)
@Parametrization.case(
    ...
    expected_alert_groups=[GroupOfAlertsByAll(alerts=[AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING],
                                              default_channel_destination=DEFAULT_CHANNEL)],
    expected_execution_properties={"had_group_by_alert": False,
                                   "had_group_by_table": False,
...
@Parametrization.case(
    ...
    list_of_alerts=[AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING, AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING],
    expected_alert_groups=[
        GroupOfAlertsByTable(alerts=[AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING, AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING],
                             default_channel_destination=DEFAULT_CHANNEL)],
    expected_execution_properties={"had_group_by_alert": False,
...
@Parametrization.case(
    ...
    expected_alert_groups=[GroupOfAlertsByTable(alerts=[AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING,
                                                        AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING],
                                                default_channel_destination=DEFAULT_CHANNEL),
                           GroupOfAlertsByTable(alerts=[AL_FAIL_MODEL2_NO_CHANNEL_NO_GROUPING],
                                                default_channel_destination=DEFAULT_CHANNEL)
                           ],
    expected_execution_properties={"had_group_by_alert": False,
                                   "had_group_by_table": True,
...
@Parametrization.case(
    ...
    expected_alert_groups=[GroupOfAlertsByTable(alerts=[AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING,
                           ...
                           GroupOfAlertsByTable(alerts=[AL_FAIL_MODEL2_NO_CHANNEL_NO_GROUPING],
                                                default_channel_destination=DEFAULT_CHANNEL),
                           GroupOfAlertsBySingleAlert(alerts=[AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_ALERT],
                                                      default_channel_destination=DEFAULT_CHANNEL)
                           ],
    expected_execution_properties={"had_group_by_alert": True,
                                   "had_group_by_table": True,
...
@Parametrization.case(
    ...
    expected_alert_groups=[GroupOfAlertsByAll(alerts=[AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING,
                                                      AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING,
                                                      AL_FAIL_MODEL2_NO_CHANNEL_NO_GROUPING],
                                              default_channel_destination=DEFAULT_CHANNEL),
                           GroupOfAlertsByTable(alerts=[AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE,
                                                        AL_ERROR_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE],
                                                default_channel_destination=DEFAULT_CHANNEL),
                           GroupOfAlertsBySingleAlert(alerts=[AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_ALERT],
                                                      default_channel_destination=DEFAULT_CHANNEL),
                           GroupOfAlertsBySingleAlert(alerts=[AL_ERROR_MODEL3_NO_CHANNEL_WITH_GROUPING_BY_ALERT],
                                                      default_channel_destination=DEFAULT_CHANNEL),
                           ],
    expected_execution_properties={"had_group_by_alert": True,
                                   "had_group_by_table": True,
...
def test_grouping_logic(default_channel, default_grouping, list_of_alerts, expected_alert_groups,
                        expected_execution_properties):
    # init
    conf = MockConfig(slack_group_alerts_by=default_grouping,
                      slack_channel_name=default_channel)
    data_monitoring_alerts = mock_data_monitoring_alerts(conf)

    # business logic
    list_of_groups = DataMonitoringAlerts._group_alerts_per_config(data_monitoring_alerts, list_of_alerts)
    ...
    if expected_execution_properties is not None:
        assert data_monitoring_alerts.execution_properties == expected_execution_properties
...
@Parametrization.case(
    ...
    alerts_list=[AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE,
                 AL_ERROR_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE],
    expected_channel=OTHER_CHANNEL
)
@Parametrization.case(
...
@Parametrization.case(
    ...
    expected_errors=[AL_ERROR_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE,
                     AL_ERROR_MODEL3_NO_CHANNEL_WITH_GROUPING_BY_ALERT],
    expected_warnings=[AL_WARN_MODEL1_NO_CHANNEL_NO_GROUPING],
    expected_fails=[AL_FAIL_MODEL1_WITH_CHANNEL_NO_GROUPING,
                    AL_FAIL_MODEL2_NO_CHANNEL_NO_GROUPING,
                    AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_ALERT,
                    AL_FAIL_MODEL2_NO_CHANNEL_WITH_GROUPING_BY_TABLE]
)
def test_alert_group_construction(grouping_class,
                                  alerts_list,
                                  default_channel,
                                  expected_owners,
                                  expected_tags,
    ...
    if expected_owners is not None:
        assert sorted(alerts_group._components_to_attn_required[OwnersComponent].split(', ')) == sorted(expected_owners)
    if expected_tags is not None:
        assert sorted([x.replace("#","") for x in alerts_group._components_to_attn_required[TagsComponent].split(", ")]) == sorted(expected_tags.split(", "))
    if expected_subs is not None:
        assert sorted(alerts_group._components_to_attn_required[SubsComponent]) == sorted(expected_subs)
