...
@pytest.mark.parametrize("start_date, end_date, database_name, query_type, expected_bindings", [
    (datetime(2025, 9, 11), datetime(2025, 9, 12), 'elementary',
     'account_usage', (datetime(2025, 9, 11, 0, 0, 0), datetime(2025, 9, 12, 23, 59, 59), 'elementary')),
    (datetime(2025, 9, 11, 1, 33, 7), datetime(2025, 9, 12, 1, 33, 7), 'elementary',
     'account_usage', (datetime(2025, 9, 11, 1, 33, 7), datetime(2025, 9, 12, 1, 33, 7), 'elementary')),
    (datetime(2025, 9, 9), None, 'elementary',
     'account_usage', (datetime(2025, 9, 9, 0, 0, 0), 'elementary')),
    (datetime(2025, 9, 9, 1, 33, 7), None, 'elementary',
     'account_usage', (datetime(2025, 9, 9, 1, 33, 7), 'elementary')),
    (datetime(2025, 9, 12), datetime(2025, 9, 13), 'elementary',
     'information_schema', (datetime(2025, 9, 12, 0, 0, 0), datetime(2025, 9, 13, 23, 59, 59))),
    (datetime(2025, 9, 12, 1, 33, 7), datetime(2025, 9, 13, 1, 33, 7), 'elementary',
     'information_schema', (datetime(2025, 9, 12, 1, 33, 7), datetime(2025, 9, 13, 1, 33, 7))),
    (datetime(2025, 9, 15, 1, 33, 7), None, 'elementary',
     'information_schema', (datetime(2025, 9, 15, 1, 33, 7),)),
    (datetime(2025, 9, 15), None, 'elementary',
     'information_schema', (datetime(2025, 9, 15, 0, 0, 0),))
])
