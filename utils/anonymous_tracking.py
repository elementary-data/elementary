...
class AnonymousTracking(object):
    ...
    def __init__(self, config_dir: str, profiles_dir: str, anonymous_usage_tracking: bool = True) -> None:
    ...
    def init(self):
        legacy_anonymous_user_id_file_name = os.path.join(self.profiles_dir, self.ANONYMOUS_USER_ID_FILE)
        anonymous_user_id_file_name = os.path.join(self.config_dir, self.ANONYMOUS_USER_ID_FILE)
