...
class ModelsAPI(APIClient):
    ...
    def get_models_runs(
        ...
        try:
            ...
            for model_unique_id, model_runs in model_id_to_runs_map.items():
                ...
                last_model_run = sorted(model_runs, key=lambda run: run.generated_at)[
                    -1
                ]
            ...
            self.append_error(error=e, api_method="get_models_runs")
            return ModelRunsWithTotalsSchema()
    ...
    def get_models(
        ...
        try:
            ...
            self.append_error(error=e, api_method="get_models")
            return dict()
    ...
    def get_sources(self) -> Dict[str, NormalizedSourceSchema]:
        try:
            ...
            self.append_error(error=e, api_method="get_sources")
            return dict()
        ...
        try:
            ...
            if exposures_results:
                for exposure_result in exposures_results:
                    normalized_exposure = self._normalize_dbt_artifact_dict(
                        exposure_result
                    )
            ...
            self.append_error(error=e, api_method="get_exposures")
            return dict()
    ...
    def get_test_coverages(self) -> Dict[str, ModelCoverageSchema]:
        try:
            ...
            self.append_error(error=e, api_method="get_test_coverages")
            return dict()
