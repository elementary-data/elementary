    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.result_description = (
            error
            if error
            else f"When the test ran at {formatted_detected_at}, the most recent record in the table had occurred {get_formatted_timedelta(self.max_loaded_at_time_ago_in_s or 0)} earlier. The most recent record found was at {formatted_max_loaded_at}."
        )
