...
class GroupOfAlerts:
    def __init__(self, alerts: List[Alert], default_channel_destination: str, env: str = "dev"):
        ...
        self._components_to_attention_required: Dict[NotificationComponent, str] = dict()
    ...
    def to_slack(self) -> SlackMessageSchema:
        ...
        for component, alerts_list in self._components_to_alerts.items():
            ...
            if component == ModelErrorComponent:
                ...
                details_blocks.append(self._message_builder.create_text_section_block(text))
    ...
    def _title_block(self):
        ...
        return self._message_builder.create_header_block(
            title
        )
    ...
    def _get_banner_block(self, env):
        ...
        return self._message_builder.create_text_section_block(f"_Env: {env_text}_")
    ...
    def _attention_required_blocks(self):
        ...
        for component, val in self._components_to_attention_required.items():
            ...
            preview_blocks.append(
                self._message_builder.create_text_section_block(f"*{component.name_in_summary}*: {text}")
            )
...
class GroupOfAlertsByTable(GroupOfAlerts):
    ...
    def _get_title(self):
        return get_shortened_model_name(self._model)
