...
import elementary.utils.dbt
from elementary.clients.dbt.dbt_runner import DbtRunner
from elementary.clients.slack.schema import SlackMessageSchema
from elementary.clients.slack.slack_client import SlackClient
...
class DataMonitoring:
    ...
    def _send_alerts_to_slack(self, alerts: List[Alert], alerts_table_name: str):
        ...
        for alert in alerts_with_progress_bar:
            ...
            sent_successfully = self.slack_client.send_message(channel_name=channel, message=alert_msg)
    ...
    def _create_tests_results(
        ...
        for test in tests_metadata:
            ...
            test_result = TestAlert.create_test_alert_from_dict(
                **metadata,
                elementary_database_and_schema=elementary.utils.dbt.get_elementary_database_and_schema(self.dbt_runner),
