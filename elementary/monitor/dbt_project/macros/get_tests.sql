    ...
    {%- if elementary.relation_exists(dbt_tests_relation) -%}
        {% set get_tests_query %}
            ...
            select
                ...
                tests.database_name as database_name,
                tests.schema_name as schema_name,
                nodes.name as model_name,
                tests.test_column_name as column_name,
                tests.name as name,
                tests.description as description,
                tests.package_name as package_name,
                tests.original_path as original_path,
                tests.test_params as test_params,
                tests.meta as meta,
                nodes.meta as model_meta,
                tests.tags as tags,
                nodes.tags as model_tags,
                tests.type as type,
                last_test_results.test_type as test_type,
                last_test_results.test_sub_type as test_sub_type,
