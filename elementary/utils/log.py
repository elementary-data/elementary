...
def get_console_handler(quiet_logs: bool = False, use_stderr: bool = False):
...
def set_root_logger_handlers(
    ...
    logger.addHandler(
        get_console_handler(quiet_logs=quiet_logs, use_stderr=use_stderr)
    )
